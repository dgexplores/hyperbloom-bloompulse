...
class AssetRegistry:
    ...
    def get_by_name(self, name: str) -> Asset | None:
    ...
    def update(self, asset_id: str, data: dict[str, Any]) -> Asset | None:
    ...
    def update_baseline(self, asset_id: str, baseline_update: dict[str, Any]) -> Asset | None:
